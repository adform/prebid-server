...
func (cfg *Configuration) setDerivedDefaults() {
	...
	setDefaultUsersync(cfg.Adapters, openrtb_ext.BidderAdformOpenRTB, "https://cm.adform.net/cookie?redirect_url="+url.QueryEscape(externalURL)+"%2Fsetuid%3Fbidder%3Dadform%26gdpr%3D{{.GDPR}}%26gdpr_consent%3D{{.GDPRConsent}}%26uid%3D%24UID")
...
func SetupViper(v *viper.Viper, filename string) {
	...
	v.SetDefault("adapters.adformOpenRTB.endpoint", "https://adx.adform.net/adx/openrtb")
